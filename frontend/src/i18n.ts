  ...
  es: {
    translation: {
      ...
      sensibilidad: {
        ...
        controlSexLabel: 'Sexo',
        controlSexHint: 'Aplica a todas las vistas de esta página.',
        ...
        ktCaption: 'La pendiente de k_t (drift) refleja la velocidad de mejora en mortalidad: cuanto más empinada la caída, más rápido bajan las primas proyectadas. España cae 2.55 veces más rápido que México (-2.767 contra -1.086), mientras que Estados Unidos cae prácticamente al mismo ritmo que México (-1.021).',
        ...
        covidDesc: 'Incluir los años 2020-2024 en el modelo Lee-Carter revela cómo la pandemia redujo la velocidad de mejora en mortalidad. La deriva pasó de -1.086 (pre-COVID) a -0.877 (periodo completo), lo que se traduce en primas entre 3% y 5% más altas.',
        ...
        crossIntro: 'El drift de Lee-Carter mide la velocidad de mejora en mortalidad. Sobre la ventana 1990-2019 y edades 0-100, España mejora 2.55 veces más rápido que México (drift -2.767 contra -1.086). Estados Unidos, en cambio, mejora a -1.021: 0.94 veces el ritmo mexicano, es decir prácticamente el mismo. El drift es una tasa medida, no una explicación: dice cuán rápido bajó la mortalidad, no por qué. La varianza explicada (77.5% México, 85.5% EUA, 95.2% España) sí revela una diferencia de estructura: en México las edades no mejoran de forma sincronizada, y los adultos jóvenes se apartan de la tendencia que sigue la mortalidad infantil. El diferencial de primas que produce todo esto aparece calculado en la tabla de abajo.',
        covidHeader: 'COVID-19: un cambio de régimen en la tendencia',
        covidIntro: 'Incluir los años 2020-2024 en Lee-Carter desplaza el drift de -1.086 a -0.877: la mejora en mortalidad se frenó 19%. Este cambio no es solo estadístico, se traduce en primas entre 3% y 5% más altas dependiendo de la edad. Para el regulador y el actuario de pricing, esto plantea una decisión real: ¿debe la tarificación usar la tendencia pre-COVID (optimista) o la tendencia completa que incorpora el retroceso pandémico?',
        ...
        crossInsight: 'El hallazgo no es España. Es Estados Unidos. La mortalidad estadounidense mejora a -1.021 por año frente a -1.086 de México: 0.94 veces el ritmo mexicano, o sea el mismo ritmo, incluso marginalmente más lento. España, a -2.767, mejora 2.55 veces más rápido que ambos. Los tres ajustes usan la misma ventana 1990-2019 y las mismas edades 0-100, así que la comparación es limpia. Lee-Carter mide la velocidad del cambio, no su causa: lo que se afirma aquí es la medición.',
        covidInsightTitle: 'DECISIÓN ACTUARIAL REAL',
        covidInsight: 'Para un actuario fijando primas 2025: usar la tendencia pre-COVID (-1.086) o incorporar el retroceso (-0.877)? La respuesta depende de si COVID fue un choque temporal o un cambio permanente de régimen. SIMA permite modelar ambos escenarios.',
      },
      metodologia: {
        title: 'Metodología',
      ...
      inicio: {
        ...
        contextP2: 'Los datos provienen de mortalidad real mexicana del INEGI (defunciones) y CONAPO (población), periodo 1990-2019 (pre-COVID), edades 0-100. Se gradúan con Whittaker-Henderson y se validan contra las tablas regulatorias mexicanas. La misma metodología se aplica a Estados Unidos y España con datos del Human Mortality Database: España mejora 2.55 veces más rápido que México (drift -2.767 contra -1.086), mientras que Estados Unidos mejora a -1.021, prácticamente el mismo ritmo que México.',
        ...
        covidTeaserDesc: 'Incluir los datos 2020-2024 hace la deriva menos negativa y encarece las primas. Las dos cifras de abajo se calculan en vivo con el motor. El COVID-19 frenó la mejora histórica en mortalidad mexicana.',
  ...
  en: {
    translation: {
      ...
      inicio: {
        ...
        contextP2: 'The data comes from real Mexican mortality via INEGI (deaths) and CONAPO (population), spanning 1990-2019 (pre-COVID), ages 0-100. Graduated with Whittaker-Henderson and validated against the Mexican regulatory tables. The same methodology is applied to the United States and Spain using Human Mortality Database data: Spain improves 2.55 times faster than Mexico (drift -2.767 against -1.086), while the United States improves at -1.021, essentially the same rate as Mexico.',
        ...
        covidTeaserDesc: 'Including 2020-2024 data makes the drift less negative and pushes premiums up. Both figures below are computed live by the engine. COVID-19 slowed the historical mortality improvement trend in Mexico.',
      ...
      sensibilidad: {
        ...
        controlSexLabel: 'Sex',
        controlSexHint: 'Applies to every view on this page.',
        ...
        ktCaption: 'The slope of k_t (drift) reflects the speed of mortality improvement: the steeper the decline, the faster projected premiums fall. Spain declines 2.55 times faster than Mexico (-2.767 against -1.086), while the United States declines at practically the same rate as Mexico (-1.021).',
        ...
        covidDesc: 'Including 2020-2024 data in the Lee-Carter model reveals how the pandemic slowed mortality improvement. The drift shifted from -1.086 (pre-COVID) to -0.877 (full period), translating to 3-5% higher premiums.',
        ...
        crossIntro: 'The Lee-Carter drift measures the speed of mortality improvement. Over the 1990-2019 window and ages 0-100, Spain improves 2.55 times faster than Mexico (drift -2.767 against -1.086). The United States, by contrast, improves at -1.021: 0.94 times the Mexican rate, that is, essentially the same. Drift is a measured rate, not an explanation: it says how fast mortality fell, not why. Explained variance (77.5% Mexico, 85.5% USA, 95.2% Spain) does reveal a structural difference: in Mexico the ages do not improve in sync, and young adults depart from the trend that infant mortality follows. The premium gap all this produces is computed in the table below.',
        covidHeader: 'COVID-19: a regime shift in the trend',
        covidIntro: 'Including 2020-2024 in the Lee-Carter model shifts the drift from -1.086 to -0.877: mortality improvement slowed by 19%. This is not just a statistical artifact --it translates to 3-5% higher premiums depending on age. For regulators and pricing actuaries, this poses a real decision: should pricing use the pre-COVID trend (optimistic) or the full trend that incorporates the pandemic setback?',
        ...
        crossInsight: 'The finding is not Spain. It is the United States. US mortality improves at -1.021 per year against Mexico\'s -1.086: 0.94 times the Mexican rate, that is, the same rate, and marginally slower. Spain, at -2.767, improves 2.55 times faster than both. All three fits use the same 1990-2019 window and the same ages 0-100, so the comparison is clean. Lee-Carter measures the speed of change, not its cause: what is asserted here is the measurement.',
        covidInsightTitle: 'REAL ACTUARIAL DECISION',
        covidInsight: 'For an actuary setting 2025 premiums: use the pre-COVID trend (-1.086) or incorporate the setback (-0.877)? The answer depends on whether COVID was a temporary shock or a permanent regime change. SIMA allows modeling both scenarios.',
      },
      metodologia: {
        title: 'Methodology',
