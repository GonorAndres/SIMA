  ...
  es: {
    translation: {
      ...
      mortalidad: {
        ...
        graduationInsightTitle: 'POR QUE GRADUAR',
        graduationInsight: 'Los conteos crudos de defunciones fluctuan aleatoriamente, especialmente en edades con poca exposicion. La graduacion revela la senal biologica verdadera: el patron Gompertz de mortalidad creciente con la edad. Sin este paso, las primas tendrian picos erraticos.',
        surfaceInsightTitle: 'QUE BUSCAR',
        surfaceInsight: 'La pendiente descendente en el eje de anos muestra la mejora historica en mortalidad. El ascenso en el eje de edades sigue la curva de Gompertz. Busca la anomalia del COVID (2020-2021) como un escalon hacia arriba en edades 40-70.',
        svdInsightTitle: 'CALIDAD DEL MODELO',
        svdInsight: 'Un 77.7% de varianza explicada significa que un solo factor temporal captura la mayoria de la variacion en mortalidad mexicana. Es menor que Espana (94.8%) porque Mexico tiene mayor heterogeneidad: diferencias regionales, mortalidad juvenil, e impacto diferenciado del COVID.',
      },
      tarificacion: {
        title: 'Tarificación',
        ...
        equivalenceExplain: 'Una prima justa significa que ni la aseguradora ni el asegurado tienen ventaja esperada: el valor presente de las primas iguala el valor presente de los beneficios. Las funciones de conmutacion (D_x, N_x, M_x) comprimen mortalidad e interes en cocientes compactos que hacen estas formulas elegantes.',
        reserveInsightTitle: 'POR QUE EXISTEN LAS RESERVAS',
        reserveInsight: 'Cobramos primas niveladas pero la mortalidad aumenta con la edad. Las primas iniciales exceden el costo del riesgo; las primas tardias no alcanzan. La reserva es el excedente acumulado que garantiza que la aseguradora pueda pagar siniestros futuros.',
        sensitivityInsightTitle: 'DOMINIO DE LA TASA DE INTERES',
        sensitivityInsight: 'Nota la convexidad: bajar la tasa incrementa las primas mas de lo que subirla las reduce. Esto se debe a que el descuento se compone exponencialmente sobre decadas de obligaciones futuras. Por eso la gestion activo-pasivo es critica para aseguradoras de vida.',
      },
      sensibilidad: {
        ...
        interestInsight: 'La tasa de interes domina porque el descuento se compone exponencialmente sobre decadas de obligaciones futuras. Un cambio de 2% a 8% produce una variacion del 101% en la prima de vida entera. Esta es la razon principal por la que la gestion activo-pasivo (ALM) es critica para aseguradoras de vida.',
        shockInsightTitle: 'ASIMETRIA FUNDAMENTAL',
        shockInsight: 'Un choque de +30% en q_x eleva las primas 16.2%, pero una mejora de -30% las reduce 18.2%. Esta convexidad es una propiedad fundamental de los productos vinculados a mortalidad: las mejoras benefician mas que los deterioros perjudican.',
        crossInsightTitle: 'PRESION COMPETITIVA',
        crossInsight: 'Las primas mexicanas son ~30% mas altas que las espanolas a cualquier edad. Esto refleja mayor mortalidad base y mejora mas lenta -- factores estructurales ligados a sistemas de salud y transiciones epidemiologicas, no a la tarificacion.',
        covidInsightTitle: 'DECISION ACTUARIAL REAL',
        covidInsight: 'Para un actuario fijando primas 2025: usar la tendencia pre-COVID (-1.076) o incorporar el retroceso (-0.855)? La respuesta depende de si COVID fue un choque temporal o un cambio permanente de regimen. SIMA permite modelar ambos escenarios.',
      },
      metodologia: {
        title: 'Metodología',
        ...
        portfolioFraming: 'Este sistema demuestra cinco competencias clave: (1) manejo de datos demograficos reales (INEGI/CONAPO), (2) modelacion estadistica avanzada (Lee-Carter via SVD, Whittaker-Henderson), (3) valuacion financiera (principio de equivalencia, funciones de conmutacion), (4) gestion de riesgos regulatoria (RCS bajo LISF/CUSF), y (5) ingenieria de software full-stack (Python + FastAPI + React + GCP). Cada seccion abajo detalla la teoria y conecta con la implementacion.',
        sections: {
          datos: 'Datos',
      ...
      inicio: {
        ...
        portfolioPitch: 'Este sistema demuestra tres competencias actuariales avanzadas implementadas como software de produccion: (1) modelacion estocastica de mortalidad con Lee-Carter y SVD, (2) valuacion financiera bajo el principio de equivalencia con funciones de conmutacion, y (3) gestion de capital regulatorio con cuatro modulos de riesgo bajo el marco LISF/CUSF de Mexico. Construido con datos reales de mortalidad mexicana (INEGI/CONAPO), 12 modulos de motor, 238 tests y una API REST desplegada en Google Cloud.',
        ...
        mortalityDesc: 'Cuanto vivirán los asegurados? Los datos crudos del INEGI son ruidosos. Aqui se graduan con Whittaker-Henderson, se modelan con Lee-Carter (SVD), y se proyectan 30 anos al futuro. Pipelines separados para hombres, mujeres y unisex.',
        viewMortality: 'Ver análisis de mortalidad',
        pricing: 'Valuacion Actuarial',
        pricingDesc: 'Cuanto debe costar una poliza? El principio de equivalencia dice que las primas deben igualar los beneficios esperados. Las funciones de conmutacion convierten esa igualdad en cocientes elegantes de M entre N.',
        calcPremiums: 'Calcular primas',
        capitalReqs: 'Cumplimiento Regulatorio',
        capitalDesc: 'Puede la aseguradora sobrevivir una crisis? Cuatro escenarios de estres agregados bajo regulacion LISF/CUSF responden esta pregunta. La correlacion negativa entre mortalidad y longevidad genera un ahorro de capital del 14.4%.',
      ...
      demo: {
        ...
        step8: 'El requerimiento de capital (RCS bajo LISF/CUSF) mide cuanto dinero necesita la aseguradora para sobrevivir un escenario adverso con probabilidad de 1 en 200. Se modelan cuatro tipos de riesgo conforme al Titulo 5 de la CUSF y se agregan con una matriz de correlacion. La diversificacion entre mortalidad y longevidad genera un ahorro del 14.4% porque son riesgos naturalmente opuestos.',
      ...
      hints: {
        product: 'Vitalicio: paga al fallecer. Temporal: solo dentro de n anos. Dotal: al fallecer o al sobrevivir.',
        sex: 'Modelo Lee-Carter ajustado por separado para cada sexo.',
        sumAssured: 'Monto pagado a beneficiarios. Tipico: $100K-$5M.',
        interestRate: 'Tasa tecnica de descuento. Menor tasa = primas mas altas.',
        term: 'Duracion de la poliza en anos. Solo para temporal y dotal.',
