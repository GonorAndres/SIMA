...
\newtcolorbox{formaldef}[1][]{breakable,colback=blue!5!white,colframe=blue!60!black,fonttitle=\bfseries,title={#1},sharp corners,boxrule=0.8pt}
\newtcolorbox{intuition}[1][]{breakable,colback=green!5!white,colframe=green!50!black,fonttitle=\bfseries,title={#1},sharp corners,boxrule=0.8pt}
\newtcolorbox{application}[1][]{breakable,colback=orange!5!white,colframe=orange!60!black,fonttitle=\bfseries,title={#1},sharp corners,boxrule=0.8pt}
\newtcolorbox{dimcheck}{breakable,colback=gray!8!white,colframe=gray!50!black,fonttitle=\bfseries,title={Dimension Check},sharp corners,boxrule=0.6pt}
...
%=============================================================================
\section{Scalar Warm-Up: Minimizing \texorpdfstring{$f(x) = ax^2 + bx + c$}{f(x) = ax² + bx + c}}
%=============================================================================
...
%=============================================================================
\section{The General Case: \texorpdfstring{$f(\bm{x}) = \bm{x}'\bm{A}\bm{x} + \bm{b}'\bm{x} + c$}{f(x) = x'Ax + b'x + c}}
%=============================================================================
